              ...
              <ul>
                ...
                <li>
                  <a class="footerLinks" href="gallery.html">
                    <i class="fa-solid fa-circle-chevron-right"></i>Our Gallery</a>
                </li>
                <li>
                  <a class="footerLinks" href="happyMoments.html">
                    <i class="fa-solid fa-circle-chevron-right"></i>Our Happy Moments</a>
                </li>
                <li>
